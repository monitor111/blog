    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-3 mb-3">
          <a href="{{ route('admin.user.create') }}" class="btn btn-block btn-primary">Додати користувача</a>
        </div>
      </div>
      <div class="row">  
        <div class="col-6">         
              ...
              <table class="table table-hover text-nowrap">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center"><a href="{{ route('admin.user.edit', $user->id) }}" class="text-success">
